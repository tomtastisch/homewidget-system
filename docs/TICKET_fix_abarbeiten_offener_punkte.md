Ziel
- Abarbeiten aller aktuell offenen TODOs in den E2E-Tests (Playwright/Contracts/Detox) und Entfernen konzeptioneller Platzhalter.
...
- TODOs in Test-Specs eliminieren, indem:
  ...
  - nicht verfügbare UI-Features nicht “vorgegaukelt”, sondern als deterministische API-/Resilience-Checks umgesetzt werden
...
- Falls ein TODO nur durch ein echtes Feature implementierbar wäre, wird stattdessen ein separates Feature-Ticket erforderlich (nicht Teil dieses Branches).
