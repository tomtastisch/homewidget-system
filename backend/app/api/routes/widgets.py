...
def create_widget(payload: WidgetCreate, session: Session = Depends(get_session), user=Depends(get_current_user)):
...
def delete_widget(widget_id: int, session: Session = Depends(get_session), user=Depends(get_current_user)):
